...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      "scriptSrc": ["'self'", 'http://localhost:4200', 'http://localhost:4200/', 'http://localhost:4000', 'http://localhost:4000/', 'http://localhost', 'http://localhost/'],
      "defaultSrc": ["'self'", 'http://localhost:4200', 'http://localhost:4200/', 'http://localhost:4000', 'http://localhost:4000/', 'http://localhost', 'http://localhost/'],
      "styleSrc": ["'self'", 'http://localhost:4200', 'http://localhost:4200/', 'http://localhost:4000', 'http://localhost:4000/', 'http://localhost', 'http://localhost/'],
...
app.use(function (req, res, next) {
  ...
  res.setHeader('Permissions-Policy', 'geolocation=(self "http://localhost:4200/" "http://localhost:4200/" "http://localhost:4000/" "http://localhost:4000/" "http://localhost/" "http://localhost/")')
  next();
});
